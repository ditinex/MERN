        ...
        <div className="h-screen bg-primary flex justify-center items-center">
          <div className="py-7 px-7 sm:px-20 rounded-xl bg-white shadow-xl">
            <div className="flex justify-center items-center gap-4">
              <MdCelebration size={29} className="text-green-600" />
            ...
            <p class="flex justify-center items-center font-bold text-2xl py-3 bg-gradient-to-r from-indigo-500 via-sky-500 to-teal-400 inline-block text-transparent bg-clip-text">
              Chris
            </p>
